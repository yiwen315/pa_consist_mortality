...
/***************  Each questionnaire cycle exclusions *****************/
    	...
    	%exclude(irt{i-1} le dtdth lt irt{i}); 
    	%exclude(treport90<1); /* reported 0 out of 3 questionnaire */
    	%output();
    end;

    else if i=5 then do;
    	%exclude(irt{i-1} le dtdth lt irt{i}); 
    	%exclude(treport92<2); /* reported 0-1 out of 4 questionnaire */
    	%output();
    end;

    else if i=6 then do;
    	%exclude(irt{i-1} le dtdth lt irt{i}); 
    	%exclude(treport94<3); /* reported 0-2 out of 5 questionnaire */
    	%output();
    end;
    	...
    	%exclude(irt{i-1} le dtdth lt irt{i}); 
    	%exclude(treport08<10); 
    	%output();
    end;

    else if i=14 then do;
    	%exclude(irt{i-1} le dtdth lt irt{i}); 
    	%exclude(treport10<11); 
    	%output();
    end;

    else if i=15 then do;
    	%exclude(irt{i-1} le dtdth lt irt{i}); 
    	%exclude(treport12<12); 
    	%output();
    end;

    else if i=16 then do;
    	%exclude(irt{i-1} le dtdth lt irt{i}); 
    	%exclude(treport14<13); 
    	%output();
    end;

    else if i=17 then do;
    	%exclude(irt{i-1} le dtdth lt irt{i}); 
    	%exclude(treport16<14); 
    	%output();  /* reported 0-13 out of 16 questionnaire */
    end;
