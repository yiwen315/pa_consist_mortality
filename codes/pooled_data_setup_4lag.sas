...
/********* create 4year - lag data *********/
data hpfs_new_4lag; set hpfs_new; 
 if interval<3 then delete; 
 if .<dtdth le irt90 then delete;

if can90 eq 1  then delete;
if str90 eq 1  then delete;
if ang90 eq 1  then delete;
if mi90 eq 1   then delete;
if cabg90 eq 1  then delete;

run;


data nhs_new_4lag; set nhs_new; 
...
data nhs2_new_4lag; set nhs2_new; 
 if interval<2 then delete; 
 if .<dtdth le irt92 then delete;

if can93 eq 1  then delete;
if str93 eq 1  then delete;
if ang93 eq 1  then delete;
if mi93 eq 1   then delete;
*if cabg93 eq 1  then delete;
...
data nhs_new_4lag; set nhs_new_4lag; id=id+1000000;periodnew=interval; run; /*start from 1990, interval=4*/
data nhs2_new_4lag; set nhs2_new_4lag; id=id+2000000;periodnew=interval+2; run; /*start from 1992, interval=2*/
data hpfs_new_4lag; set hpfs_new_4lag; id=id+3000000;periodnew=interval+1; run; /* start from 1990, interval=3*/
...
data pooled_4lag;
	set nhs_new_4lag nhs2_new_4lag hpfs_new_4lag end=_end_;
