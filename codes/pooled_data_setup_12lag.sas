...
/********* create 12year - lag data *********/
data hpfs_new_12lag; set hpfs_new; 
 if interval<7 then delete; 
 if .<dtdth le irt98 then delete;

if can90 eq 1 or can92 eq 1 or can94 eq 1 or can96 eq 1 or can98 eq 1 then delete;
if str90 eq 1 or str92 eq 1 or str94 eq 1 or str96 eq 1 or str98 eq 1 then delete;
if ang90 eq 1 or ang92 eq 1 or ang94 eq 1 or ang96 eq 1 or ang98 eq 1 then delete;
if mi90 eq 1 or mi92 eq 1 or mi94 eq 1 or mi96 eq 1 or mi98 eq 1 then delete;
if cabg90 eq 1 or cabg92 eq 1 or cabg94 eq 1  or cabg96 eq 1 or cabg98 eq 1 then delete;

run;


data nhs_new_12lag; set nhs_new; 
 if interval<8 then delete; 
 if .<dtdth le irt98 then delete;
...
data nhs2_new_12lag; set nhs2_new; 
 if interval<6 then delete; 
 if .<dtdth le irt00 then delete;

if can93 eq 1 or can95 eq 1 or can97 eq 1 or can99 eq 1 or can01 eq 1 then delete;
if str93 eq 1 or str95 eq 1 or str97 eq 1 or str99 eq 1 or str01 eq 1 then delete;
if ang93 eq 1 or ang95 eq 1 or ang97 eq 1 or ang99 eq 1 or ang01 eq 1 then delete;
if mi93 eq 1 or mi95 eq 1 or mi97 eq 1 or mi99 eq 1 or mi01 eq 1 then delete;
           if cabg95 eq 1 or cabg97 eq 1 or cabg99 eq 1 or cabg01 eq 1 then delete;
...
data nhs_new_12lag; set nhs_new_12lag; id=id+1000000;periodnew=interval; run; 
data nhs2_new_12lag; set nhs2_new_12lag; id=id+2000000;periodnew=interval+2; run; 
data hpfs_new_12lag; set hpfs_new_12lag; id=id+3000000;periodnew=interval+1; run; 
...
data pooled_12lag;
	set nhs_new_12lag nhs2_new_12lag hpfs_new_12lag end=_end_;
