...
%pre_pm(data=pooled, out=pooled_py, timevar=periodnew,
        ...
        case= alldead cvddead noncvddead cancerdead neurodead, 
        var=joint );

%pm(data=pooled_py, case= alldead cvddead noncvddead cancerdead neurodead, 
...
proc export data=&event._out
            outfile='/udd/hpyzh/pa_consist/pooled/pct/pooled_pct.xlsx' dbms=xlsx replace;  sheet="&event.";
